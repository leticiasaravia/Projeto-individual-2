...
describe('userController', () => {
  ...
  test('getUserById deve retornar o usuário correto', async () => {
    const mockUser = { id: '1', nome: 'John Doe', email: 'john@example.com' };
    req.params = { id: '1' };
  ...
  test('createUser deve criar um novo usuário', async () => {
    const newUser = { id: '1', nome: 'John Doe', email: 'john@example.com' };
    req.body = { nome: 'John Doe', email: 'john@example.com' };
